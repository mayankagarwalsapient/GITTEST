...
private var textFld:TextField;
    ...
    public function render():void {
		...
		var formula:Number = (user.rightFoot.position.depthRelative.y* explicitHeight) - (user.head.position.depthRelative.y* explicitHeight);
		var centi:Number = formula * 2.54 / 96;
		
		textFld.text = String(centi * 15);
		textFld.x = 800;
		addChild(textFld);		
