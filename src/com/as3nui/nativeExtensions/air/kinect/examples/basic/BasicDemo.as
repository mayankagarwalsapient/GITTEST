...
public class BasicDemo extends DemoBase {
    ...
    private function initUI(deviceSettings:KinectSettings):void {
        ...
        var mainLayout:XML = <comps>
            ...
            <Window title="Device Messages" id="deviceMessagesWindow" x="0" y = "200" width="200" height="350" minimized="false" hasMinimizeButton="true">
    ...
    protected function depthImageUpdateHandler(event:CameraImageEvent):void {
      ...
      //  depthBitmap.bitmapData = event.imageData;
		if(device.users.length>0){
			if(device.users[0].userMaskData != null){
		depthBitmap.bitmapData =device.users[0].userMaskData;
			}
		}
